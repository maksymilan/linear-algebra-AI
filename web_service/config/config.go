...
func ConnectDB() *gorm.DB {
	...
	err = db.AutoMigrate(&auth.User{}, &grading.GradeResult{}, &chat.ChatSession{}, &chat.ChatMessage{}, &assignment.Assignment{}, &assignment.Submission{}, &textbook.Textbook{}, &auth.VerificationCode{}, &favorite.FavoriteExercise{})
	if err != nil {
